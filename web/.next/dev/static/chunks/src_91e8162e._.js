...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const syncUser = {
                "AuthProvider.useEffect.syncUser": async ()=>{
                    if (!user) {
                        setAppUser(null);
                    ...
                    try {
                        ...
                        unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(userRef, {
                            "AuthProvider.useEffect.syncUser": async (snapshot)=>{
                                if (snapshot.exists()) {
                                    setAppUser({
                                        uid: user.uid,
                                        ...snapshot.data()
                        ...
                        }["AuthProvider.useEffect.syncUser"]);
                    } catch (err) {
...
_s(AuthProvider, "nA2owHGTFstW4zZu/+Et5bsdOMA=", false, function() {
    return [
...
_s(NavBar, "U1kqucILZfQ62rmtGDPjyy/2o+U=", false, function() {
    return [
...
//# sourceMappingURL=src_91e8162e._.js.map